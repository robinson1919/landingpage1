...
<body>
	<div>
			...
			<div class="sh-group-1">
				<div class="sh-icon-group-container">
					<figure class="sh-main-icon-group">
						<img class="news-paper-icon sh-hide-on-mobile" src="icons/news-paper.svg" alt="news paper Icon" />
						<img class="sh-icon sh-hide-on-mobile" src="icons/sh-icon.svg" alt="SH Icon" />
						<img class="sh-paper sh-hide-on-mobile" src="icons/sh-paper.svg" alt="SH Paper Icon" />
						<img class="sh-white-circle sh-hide-on-mobile" src="icons/sh-circle.svg" alt="SH White Circle Icon" />
						<img class="sh-blue-paper sh-hide-on-mobile" src="icons/blue-paper.svg" alt="Blue Paper" />
						<img class="sh-blue-circle sh-hide-on-mobile" src="icons/gradient-blue-circle.svg" alt="">
						<img class="sh-white-paper sh-hide-on-mobile" src="icons/white-paper.svg" alt="White Paper" />
						<img class="sh-dashboard-icon sh-hide-on-mobile" src="icons/yellow-shadow.svg" alt="Dashboard Screen" />
						<img class="sh-search-bar sh-hide-on-mobile" src="icons/search-bar.svg" alt="Dashboard Screen" />
				...
				<div class="sh-section-title-group">
					<h1 class="sh-page-title">
						...
						<img class="main-logo" src="icons/enterprise-logo1.svg" alt="enterprise logo">
		...
		<section id="accelerate" class="sh-section-2">
			<h2 class="sh-section-title">Engage and grow your brand with Sales-Hub link management solution.</h2>
		</section>
		...
		<section id="get-started" class="sh-section-4-1">
			...
			<h2 class="sh-section-title">Take your links to a whole new level</h2>
			<button class="getStartedBtn sh-button sh-show-contact-form">Get Started</button>
