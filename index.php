	...
	<div>
		...
		<section id="show-room" class="sh-section" style="display: none;">
			<div class="show-room-head">
				<ul class="show-room-selector-container">
					<li class="show-room-selector active">
						<a href="#" data-index="0" class="show-room-link">
							<img src="icons/dashboard-icon.svg" alt="Dashboard" />
						</a>
					</li>
					<li class="show-room-selector">
						<a href="#" data-index="1" class="show-room-link">
							<img src="icons/sales-icon.svg" alt="Sales" />
						</a>
					</li>
					<li class="show-room-selector">
						<a href="#" data-index="2" class="show-room-link">
							<img src="icons/scan-inventory-icon.svg" alt="Scan Inventory" />
						</a>
					</li>
					<li class="show-room-selector">
						<a href="#" data-index="3" class="show-room-link">
							<img src="icons/inventory-icon.svg" alt="Inventory" />
						</a>
					</li>
					<li class="show-room-selector">
						<a href="#" data-index="4" class="show-room-link">
							<img src="icons/payroll-icon.svg" alt="Payroll" />
						</a>
					</li>
					<li class="show-room-selector">
						<a href="#" data-index="5" class="show-room-link">
							<img src="icons/agent-icon.svg" alt="Agent" />
						</a>
					</li>
				</ul>
			</div>
			<div class="show-room-body">
				...
				<div class="show-room-section" data-index="1">
					<div class="show-room-section-image-container">
						<img class="show-room-image" src="icons/sales-dashboard-icon.svg" alt="Sales Dashboard" />
					</div>
					<div class="show-room-section-text-container">
						<h3 class="show-room-section-title">Sales</h3>
						<h5 class="show-room-section-subtitle">Access your sales anytime, anywhere.</h5>
						<p class="show-room-section-description">
							Review your sales and generate custom reports in a fast and simple way.
						</p>
						<a href="#" class="sh-button sh-login-button sh-show-contact-form">
							Schedule Your Demo
						</a>
				...
				<div class="show-room-section" data-index="2">
					<div class="show-room-section-image-container">
						<img class="show-room-image" src="icons/scan-inventory-dashboard-icon.svg"
							alt="Scan Inventory Dashboard" />
					</div>
					<div class="show-room-section-text-container">
						<h3 class="show-room-section-title">Scan Inventory</h3>
						<h5 class="show-room-section-subtitle">
							Manage your inventory with our barcode and QR code scanner.
						</h5>
						<p class="show-room-section-description">
							Scan your code to keep up with every stock move, improve internal operations, and
							increase accuracy.
						</p>
						<a href="#" class="sh-button sh-login-button sh-show-contact-form">
							Schedule Your Demo
				...
				<div class="show-room-section" data-index="3">
					<div class="show-room-section-image-container">
						<img class="show-room-image" src="icons/inventory-dashboard-icon.svg"
							alt="Inventory Dashboard" />
					</div>
					<div class="show-room-section-text-container">
						<h3 class="show-room-section-title">Inventory</h3>
						<h5 class="show-room-section-subtitle">
							Control your inventory levels across multiple channels in just one place.
						</h5>
						<p class="show-room-section-description">
							Keep track of your inventory, avoid stockouts and maximize your business potential
				...
				<div class="show-room-section sh-no-grid" data-index="4">
					<!-- CAROUSEL -->
					<div class="show-room-payroll-carousel-wrapper">
						<div class="sh-carousel-selector-container">
							<a href="#" class="sh-carousel-selector sh-button active" data-slide="0">
								My Payroll
							</a>
							<a href="#" class="sh-carousel-selector sh-button" data-slide="1">Team Payroll</a>
						</div>
						<div class="sh-carousel">
							<div class="sh-carousel__content initial">
								<div class="show-room-section-image-container">
									<img class="show-room-image" src="icons/my-payroll-dashboard-icon.svg"
										alt="Payroll Dashboard" />
								</div>
								<div class="show-room-section-text-container">
									<h3 class="show-room-section-title">My Payroll</h3>
									<h5 class="show-room-section-subtitle">
										Effortlessly navigate through all your payroll related activities.
									</h5>
									<p class="show-room-section-description">
										Stay up-to-date on every detail and movement on your payroll without a hassle.
									</p>
									<a href="#" class="sh-button sh-login-button sh-show-contact-form">
										Schedule Your Demo
									</a>
							...
							<div class="sh-carousel__content">
								<div class="show-room-section-image-container">
									<img class="show-room-image" src="icons/team-payroll-dashboard-icon.svg"
										alt="Payroll Dashboard" />
								</div>
								<div class="show-room-section-text-container">
									<h3 class="show-room-section-title">Team Payroll</h3>
									<h5 class="show-room-section-subtitle">
										Oversee your team's payroll with our top-tier service.
									</h5>
									<p class="show-room-section-description">
										Save time and keep an eye on every agent's payroll with our practical
										solution.
									</p>
									<a href="#" class="sh-button sh-login-button sh-show-contact-form">
										Schedule Your Demo
				...
				<div class="show-room-section" data-index="5">
					<div class="show-room-section-image-container">
						<img class="show-room-image" src="icons/agent-dashboard-icon.svg"
							alt="Onboarding Reports Dashboard" />
					</div>
					<div class="show-room-section-text-container">
						<h3 class="show-room-section-title">Onboarding Reports</h3>
						<h5 class="show-room-section-subtitle">
							Successfully onboard people into your business while saving time and money.
						</h5>
						<p class="show-room-section-description">
							Increase productivity by accelerating your onboarding process. Employees can fill
							out and sign forms digitally, everything will be stored online and you can access
							employee records anytime.
						</p>
						<a href="#" class="sh-button sh-login-button sh-show-contact-form">
							Schedule Your Demo
						</a>
		...
		<section id="pricing" class="sh-section-4">
			<div class="sh-sub-section sh-plans-that-scale-section">
				<h2 class="sh-sub-section-title">Plans that scale with you.</h2>
